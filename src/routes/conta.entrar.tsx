...
export const Route = createFileRoute("/conta/entrar")({
  component: ContaLoginPage,
  head: () => ({
    meta: [
      { title: "Entrar na minha conta | ZANKAR Auto Parts" },
      { name: "description", content: "Acesse sua conta de cliente na ZANKAR Auto Parts." },
    ],
  }),
});

function ContaLoginPage() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    if (!customerRow) {
      ...
      setErr("Essa conta não tem acesso liberado. Fale com a loja.");
      setLoading(false);
      return;
    }
      ...
      <div className="mx-auto grid min-h-screen max-w-6xl grid-cols-1 lg:grid-cols-2">
          ...
          <div className="relative z-10 flex h-full flex-col justify-between p-10">
            ...
            <div>
              <h2 className="font-display text-4xl font-bold leading-tight">
                Sua conta, <span className="text-primary">seus pedidos.</span>
              </h2>
              <p className="mt-3 max-w-md text-muted-foreground">
                Acesse com o e-mail e senha cadastrados pela loja para acompanhar seus pedidos.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-center p-6 sm:p-10">
          <div className="w-full max-w-md">
            ...
            <h1 className="font-display text-3xl font-bold md:text-4xl">Entrar na minha conta</h1>
            <p className="mt-2 text-muted-foreground">
              Use o e-mail e senha que a loja cadastrou para você.
            </p>
